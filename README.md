...
1. **选择任意周次**: 从过去52周到未来52周的任意时间
2. **智能文件重命名**: 上传的文件自动重命名为选择的时间格式
3. **友好显示**: 周次以易读的格式显示（如：2025年第32周 (08月04日-08月10日)）

**文件命名示例**:
- 选择周次：2025-W32
- 保存文件名：2025-W32-0804-0810.jpg

**API端点**:
- `GET /api/week-options`: 获取所有可用周次选项
